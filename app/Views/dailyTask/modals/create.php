  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createTaskModalLabel">Create New Daily Task</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="createTaskForm" class="btn btn-primary">Create Daily Task</button>
      </div>
    </div>
  </div>
</div>